Public Class NeuralNet
    ...
    Sub FeedForward(Training As Boolean)
    ...
    Sub TrainNet()
        ...
        For y = 0 To 2
            ...
            For x = 0 To 2
                ...
                If Batchx.NewInputs(x + y * 3) = 1 Then '
                    '
                    '
                    '
                    '
                ...
                If Batchx.NewInputs(x + y * 3) = 0.5 Then
                    '''''
                    '
                    '
                    '
        ...
        Module1.WInX = False
        Module1.CheckWin()
        If Not Module1.Win0 Or Not Module1.Win0 Or Not IsBoardFull() Then
        ...
        Target = (Batchx.ChangeInReward + 1) / 2 + OutputNeuron
        'backprop
