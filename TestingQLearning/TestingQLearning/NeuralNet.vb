Public Class NeuralNet
    ...
    Dim BatchTrain As Integer = 0

    Dim BatchLimit As Integer = 400
    ...
    Dim NumOfBatches As Integer = -350
    ...
    Sub PlayGame()
        ...
        While InGame
            ...
            If XPLayer - 1 > OldX Or XPLayer + 1 < OldX Then
                Console.WriteLine()
            End If
            If YPLayer - 1 > OldY Or YPLayer + 1 < OldY Then
                Console.WriteLine()
            End If
    ...
    Sub TrainNet(Optional TrainingBatch As Batch = Nothing)
        ...
        If BatchCounter = 10 Then
            ...
            For y = 0 To NoOfHiddens
                For x = 0 To NoOfOutputs - 1
                    If y = NoOfHiddens Then
                        DeltaHiddenBias(x) /= 10
                    Else
                        DeltaHOWeights(x + y * NoOfOutputs) /= 10
                    End If
                Next
            Next
            ...
            For y = 0 To NoOfInputs
                For x = 0 To NoOfHiddens - 1
                    If y = NoOfInputs Then
                        DeltaInputBias(x) /= 10
                    Else
                        DeltaIHWeights(x + (y * NoOfHiddens)) /= 10
                    End If
                Next
            Next
